...
# XXD Panel 211｜مشهد هندسي بألوان مستمدة من المعنى
...
مشهد هندسي بألوان مستمدة من المعنى
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 211 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-211`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-211 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-211-prompt.en.md) أو [بالصينية](references/xxd-panel-211-prompt.zh-CN.md).
